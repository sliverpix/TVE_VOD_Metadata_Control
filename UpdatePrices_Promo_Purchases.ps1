...
{
    Write-Debug "[DEBUG] Using input file: $input_txt_file"
    ...
    Write-Debug "[Debug] :: ALT_CODE :: $($alt_code)" 
    Write-Debug "[Debug] :: SD PRICE :: $($sd_price)"
    Write-Debug "[Debug] :: HD PRICE :: $($hd_price)"
    ...
    Write-Debug "[Debug] :: SQL QUERY :: $($SqlQuery)"
